...
import se.backede.generics.mock.TestEntity;
import se.backede.generics.mock.EntityMock;
...
public class TestTypeCheck {
     ...
     *
     * @throws se.backede.generics.persistence.exception.TypeCastException
     */
    @Test
